...
public class ShamanGrade1  extends Shaman {
    private String BackPath;
    public ShamanGrade1(String Name, int Lvl, int healthpoint, double amountCursedEnergy, float xPos, float yPos) {
        super(Name, Lvl, healthpoint, amountCursedEnergy, xPos, yPos);
        this.BackPath = randomPngForMicroObj(Paths.MICRO_GR1);
    ...
    public ShamanGrade1() {
        this("ShamanGrade1", 7, 100, 5000.0, 300, 300);
    }
    ...
    public void loadImage() {
        if (this.getImageView() == null || this.getGradeImageView() == null) {
            ...
            this.setGradeImageView(new ImageView(Objects.requireNonNull(getClass().getResource(Paths.grade1Path)).toExternalForm()));
